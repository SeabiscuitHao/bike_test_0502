<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"F:\www\2018\practice_blog\think\public/../application/admin\view\cate\add.html";i:1525231748;s:83:"F:\www\2018\practice_blog\think\public/../application/admin\view\common\header.html";i:1524052063;s:81:"F:\www\2018\practice_blog\think\public/../application/admin\view\common\left.html";i:1524481480;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('cate/add'); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">栏目等级</label>
                            <div class="col-sm-6">
                                <select name="pid">
                                    ...
                                    <?php if(is_array($category) || $category instanceof \think\Collection || $category instanceof \think\Paginator): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$category): $mod = ($i % 2 );++$i;?>
                                        <option name="pid" value="<?php echo $category['id']; ?>"><?php echo str_repeat('-',$category['level']*8); ?><?php echo $category['catename']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label>
                                    <input checked="checked" name="type" type="radio" value="1">
